...
///
/// There are always 32 channels. But, only 16 of them may be initialized. This depends
/// on the chip variant.
pub const DMA_CHANNEL_INIT: [Option<super::Channel>; 32] = [
...
pub const DMA_MULTIPLEXER_ADDRESS: *const u32 = 0x400E_C000 as *const _;
/// Address to the DMA peripheral registers
pub const DMA_ADDRESS: *const u32 = 0x400E_8000 as *const _;
