...
pub unsafe fn set_arm_clock(
    mut hz: u32,
    ccm: *const ral::ccm::RegisterBlock,
    ccm_analog: *const ral::ccm_analog::RegisterBlock,
    dcdc: *const ral::dcdc::RegisterBlock,
) -> (u32, u32) {
